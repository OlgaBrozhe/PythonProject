...
def test_add_contact(app):
    ...
    contact = ContactForm(contact_name="TestName", contact_lastname="TestLastName", contact_email="TestEmail",
                          contact_company="TestCompany", contact_homephone="+14250000000", contact_mobile="+14250000001",
                          contact_workphone="+14250000002", contact_secondary_phone="+14250000003", contact_fax="+14250000004")
